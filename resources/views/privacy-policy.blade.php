        ...
        <br><br>
        This privacy statement (“Privacy Statement”) applies to the treatment of personally identifiable information submitted by, or otherwise obtained from, you in connection with the associated application (“Application”). The Application is provided by {{ config('app.name') }} (and may be provided by {{ config('app.name') }} on behalf of a {{ config('app.name') }} licensor or partner (“Application Partner”). By using or otherwise accessing the Application, you acknowledge that you accept the practices and policies outlined in this Privacy Statement.
        <br><br>
        WHAT PERSONAL INFORMATION DOES {{ config('app.name') }} COLLECT?
        <br><br>
        ...
        We receive and store certain types of usage related information whenever you interact with Application. For example, {{ config('app.name') }} may automatically receive and record information regarding your computer’s IP address, browser information, Facebook user ID, Facebook Page fan status, and URLs accessed. Such information may be shared in aggregate (non-personally identifiable) form with our partners.
        <br><br>
        HOW DOES {{ config('app.name') }} USE THE INFORMATION IT COLLECTS?
        <br><br>
        {{ config('app.name') }} uses the information described in this Privacy Statement (i) internally, to analyze, develop and improve its products and services, and (ii) as set forth below in the “Will {{ config('app.name') }} Share any of the personal information it Collects” section below.
        <br><br>
        APPLICATION PARTNER TREATMENT OF PERSONAL INFORMATION.
        <br><br>
        {{ config('app.name') }} may provide personal information to the applicable Application Partner. The Application Partner’s use of your personal information is subject to the Application Partner’s separate privacy policy – and not this Privacy Statement. The Application Partner’s privacy policy is linked to from within the Partner’s Facebook application.
        <br><br>
        WILL {{ config('app.name') }} SHARE ANY OF THE PERSONAL INFORMATION IT RECEIVES?
        <br><br>
        ...
        <br><br>
        {{ config('app.name') }} allows you to access the following information about you for the purpose of viewing, and in certain situations, updating that information. This list may change in the event the Application changes.
        <br><br>
