...
@section('body')
    ...
    <ul class="list-reset my-4">
       ...
       <li class="inline">
            <a class="mt-6 sm:mt-0 mx-auto sm:mx-2 max-w-xs rounded-full text-center leading-none font-semibold inline-block px-8 py-3 border-2 border-teal bg-teal text-white hover:border-teal-light hover:bg-teal-light no-underline" href="https://itunes.apple.com/us/podcast/stauffers-on-science/id1330250282?mt=2">iTunes</a>
        </li>
       <li class="inline">
            <a class="mt-6 sm:mt-0 mx-auto sm:mx-2 max-w-xs rounded-full text-center leading-none font-semibold inline-block px-8 py-3 border-2 border-teal bg-teal text-white hover:border-teal-light hover:bg-teal-light no-underline" href="https://rss.simplecast.com/podcasts/4062/rss">RSS</a>
        </li>
    </ul>
@endsection
